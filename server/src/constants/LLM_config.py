...
Your feedback should be as specific to the assignment as possible. Shy away from general feedback and make it as tailored as possible to help the student improve. 
...
RUBRIC = """
 <table>
        <tr>
            <th>Criteria</th>
            <th>Excellent (9-10) (level 1)</th>
            <th>Good (7-8) (level 2)</th>
            <th>Satisfactory (5-6) (level 3)</th>
            <th>Needs Improvement (0-4) (level 4)</th>
        </tr>
        <tr>
            <td>Introduction (10pts)</td>
        ...
        <tr>
            <td>Situation Description (10pts)</td>
        ...
        <tr>
            <td>Decision-Making Process (10pts)</td>
        ...
        <tr>
            <td>Grammar and Mechanics (10pts)</td>
